...
function startRipple (type, event) {
...
function handleTouchStart (ev) {
  if (ev.changedTouches) {
    for (var i = 0, len = ev.changedTouches.length; i < len; i++) {
      startRipple(ev.type, ev.changedTouches[i]);
    }
  }
}

var Ripple = {render: function(){with(this){return _h('div',{attrs:{"style":"position: relative"}},[_t("default"),_h('div',{staticClass:"ripple-js",on:{"mousedown":handleMouseDown,"touchend":handleTouchStart}})])}},staticRenderFns: [],
  name: 'ripple',
  methods: {
    handleMouseDown: function handleMouseDown$1 (ev) {
      handleMouseDown(ev);
    },
    handleTouchStart: function handleTouchStart$1 (ev) {
      handleTouchStart (ev);
    }
  }
};

var App = {render: function(){with(this){return _h('div',{staticClass:"app"},[_h('ripple',{staticClass:"alert"},["Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."])])}},staticRenderFns: [],
  data: function data () {
    return {
